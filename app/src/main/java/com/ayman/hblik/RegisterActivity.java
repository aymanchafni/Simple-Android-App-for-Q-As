...
public class RegisterActivity extends AppCompatActivity {
    ...
    private TextInputLayout mfName, mlName;
    private static String birth_day, birth_year, birth_month;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        Spinner spinner_day = findViewById(R.id.birth_day);
        ...
        //
        Spinner spinner_month = findViewById(R.id.birth_month);
        ...
        //
        Spinner spinner_year = findViewById(R.id.birth_year);
        ...
        ImageView next_register = findViewById(R.id.next_register);
